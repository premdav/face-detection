...
class Register extends React.Component {
    ...
    onSubmitRegister = () => {
        fetch('https://calm-everglades-47797.herokuapp.com/register', {
            method: 'post',
            ...
            <article className="br3 ba b--white-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
                <main className="pa4 white-80">
                    <div className="measure">
                        ...
                        <div className="">
                            <input
                             onClick={this.onSubmitRegister} className="b ph3 pv2 white input-reset ba b--white bg-transparent grow pointer f6 dib" type="submit" value="Register" />
                        </div>
